...
namespace School_Manager
{
    public partial class New_Class : Form
    {
        ...
        public New_Class(Class_Editor classEditor)
        {
            InitializeComponent();
            this.classEditor = classEditor;

            Start_Page.startPage.classes.Add(new Class("new class", new BindingList<Student>()));

            selectedClass = Start_Page.startPage.classes.ElementAt(classEditor.listBox1.Items.Count-1);
        ...
        private void NewClass_FormClosing(object sender, FormClosingEventArgs e)
        {
            classEditor.listBox1.DisplayMember = null;
            classEditor.listBox1.DisplayMember = "name";
            classEditor.Show();
