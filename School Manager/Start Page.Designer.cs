namespace School_Manager
{
    partial class Start_Page
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.Size = new Size(273, 65);
            button1.TabIndex = 1;
            button1.Text = "Teacher Login";
            ...
            button2.Location = new Point(264, 309);
            button2.Name = "button2";
            button2.Size = new Size(273, 64);
            button2.TabIndex = 2;
            button2.Text = "Administrator Login";
            ...
            label2.Location = new Point(264, 124);
            label2.Name = "label2";
            label2.Size = new Size(278, 20);
            label2.TabIndex = 3;
            label2.Text = "For teachers and non-administrator staff:";
            ...
            label3.Location = new Point(318, 277);
            label3.Name = "label3";
            label3.Size = new Size(164, 20);
            label3.TabIndex = 4;
            label3.Text = "For administrators only:";
            // 
            // Start_Page
            // 
            ...
            Name = "Start_Page";
            Text = "School Manager";
            FormClosing += Start_Page_FormClosing;
